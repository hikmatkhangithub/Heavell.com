<?php 
 ...
 <?php
				$sql=" SELECT category.categoryName,brand.brandName,category.id, product.id, product.productName, product.productDescription, product.image, product.price, product.instock, product.brandid, product.categoryid FROM category, product, brand WHERE brand.id=product.brandid and category.id= product.categoryid and category.gender='female' and product.productName like '%$search%' ORDER BY product.id DESC ";
